          ...
          <div className="bg-white rounded-xl p-6 border">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
              {[
                ...
                {
                  label: t("Εκτιμώμενα έσοδα μέσω Mastori", "Estimated revenue via Mastori"),
            ...
            <div className="mt-6 p-4 bg-gray-50 rounded-xl text-xs text-gray-500">
              ...
              <p>
                {t(
                  "Τα εκτιμώμενα έσοδα βασίζονται στις ολοκληρωμένες κρατήσεις μέσω Mastori.gr πολλαπλασιασμένα με τη μέση τιμή εργασίας της κατηγορίας σου. Δεν περιλαμβάνουν εργασίες εκτός πλατφόρμας. Η τιμολόγηση είναι προαιρετική — μπορείτε να αφήσετε το πεδίο κενό ή να γράψετε «κατόπιν εκτίμησης».",
                  "Estimated revenue is based on completed bookings through Mastori.gr multiplied by the average job price for your category. Does not include off-platform jobs. Pricing is optional — you can leave the field empty or write 'upon assessment'."
                )}
              </p>
            </div>
          </div>
