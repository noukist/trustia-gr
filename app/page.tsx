      ...
      <div className="max-w-[1200px] mx-auto py-12 md:py-16 lg:py-20">
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_380px] gap-10 lg:gap-12 items-center">
          ...
          <div>
            ...
            {/* ── SEARCH BAR ── */}
            <div className="bg-white rounded-2xl border-[1.5px] border-gray-200 shadow-[0_4px_24px_rgba(0,0,0,0.07)] p-2 mb-5 max-w-[800px] focus-within:border-[var(--color-primary)] transition-colors">
