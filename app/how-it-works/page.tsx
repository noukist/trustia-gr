...
// People searching "πώς λειτουργεί το mastori" land here.
// =============================================================
...
export default function HowItWorksPage() {
  ...
  const customerSteps = [
    ...
    },
    {
      ...
      titleEl: "Πληρωμή",
      titleEn: "Payment",
      descEl: "Πληρώνεις απευθείας τον επαγγελματία — μετρητά, IRIS, ή όπως συμφωνήσετε. Το Mastori.gr δεν μεσολαβεί στην πληρωμή. Χωρίς κρυφές χρεώσεις.",
      descEn: "You pay the professional directly — cash, IRIS, or however you agree. Mastori.gr does not process payments. No hidden fees.",
    },
    {
      number: "6",
      icon: "⭐",
  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        >
          {t("Πώς Λειτουργεί το Mastori.gr", "How Mastori.gr Works")}
        </h1>
            ...
            {[
              {
                ...
                aEl: "Τίποτα. Η χρήση του Mastori.gr είναι εντελώς δωρεάν για πελάτες. Αναζητήστε, κλείστε ραντεβού, αφήστε κριτική — χωρίς χρέωση.",
                aEn: "Nothing. Using Mastori.gr is completely free for customers. Search, book, leave reviews — no charge.",
              },
              {
                qEl: "Πώς πληρώνω τον επαγγελματία;",
                qEn: "How do I pay the professional?",
                aEl: "Απευθείας. Το Mastori.gr δεν μεσολαβεί στην πληρωμή. Συμφωνείτε μεταξύ σας — μετρητά, IRIS, μεταφορά, ό,τι σας βολεύει.",
                aEn: "Directly. Mastori.gr does not process payments. You agree between yourselves — cash, IRIS, transfer, whatever works.",
              },
              {
              ...
              },
              {
                ...
                aEl: "Ο Douleutaras χρεώνει τον επαγγελματία 15-20% από κάθε εργασία. Αυτό σημαίνει ότι ο υδραυλικός που θα σε χρεώσει €100, δίνει €15-20 στην πλατφόρμα. Στο Mastori.gr, ο επαγγελματίας πληρώνει ένα σταθερό €15/μήνα ανεξαρτήτως πόσα κερδίζει — άρα δεν έχει λόγο να \"φουσκώσει\" τη δική σου τιμή.",
                aEn: "Douleutaras charges the professional 15-20% of every job. This means the plumber who charges you €100 gives €15-20 to the platform. On Mastori.gr, the professional pays a flat €15/month regardless of earnings — so they have no reason to inflate your price.",
              },
              {
