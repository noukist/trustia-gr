...
// Run on every route except static assets, API routes, auth callbacks,
// and Next.js metadata routes (robots.txt, sitemap.xml).
// robots.txt and sitemap.xml are generated by app/robots.ts and app/sitemap.ts
// respectively — next-intl must NOT intercept them or they return 404.
export const config = {
  matcher: [
