...
// =============================================================
// Client component for the reset-password flow.
// Parent (server component) handles generateMetadata.
//
// All strings come from the "auth.resetPassword" namespace.
// =============================================================
      ...
      >
        ...
        {success ? (
          <div style={{ textAlign: "center" }}>
            <CheckCircle2 size={48} style={{ color: "#27AE60", marginBottom: "1rem" }} />
            <p
              style={{
                fontWeight:   700,
                fontSize:     "1rem",
