    ...
    <section className="max-w-4xl mx-auto px-6 py-10">
      ...
      >
        ...
        <p className="text-gray-600 text-sm md:text-base leading-relaxed mb-4">
          {t(
            "Οι επαγγελματίες δουλεύουν σκληρά. Δεν πρέπει να πληρώνουν 15-20% για κάθε εργασία απλά για να βρουν πελάτες. Στο Mastori.gr, ο επαγγελματίας πληρώνει ένα δίκαιο, σταθερό ποσό και κρατάει ό,τι κερδίζει. Ο πελάτης βρίσκει αξιόπιστους επαγγελματίες με επαληθευμένες κριτικές — χωρίς κρυφές χρεώσεις, χωρίς εκπλήξεις.",
            "Professionals work hard. They shouldn't pay 15-20% of every job just to find clients. On Mastori.gr, the professional pays a fair, fixed amount and keeps everything they earn. Customers find reliable professionals with verified reviews — no hidden fees, no surprises."
          )}
        </p>
