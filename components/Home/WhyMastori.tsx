// =============================================================
// WhyMastori.tsx — Trust section explaining why customers
// should use Mastori.gr instead of calling randomly
// =============================================================
...
// -------------------------------------------------------------
interface WhyMastoriProps {
  lang: "el" | "en";
}

export default function WhyMastori({ lang }: WhyMastoriProps) {
  // Helper: translate between Greek and English
  const t = (el: string, en: string) => (lang === "el" ? el : en);

  // ─── TRUST PILLARS ───
  // Three reasons customers can trust Mastori.gr
  const pillars = [
    {
      icon: "✓",
  ...
  return (
    <section className="max-w-5xl mx-auto px-6 py-12">
      ...
      >
        {t("Γιατί Mastori.gr;", "Why Mastori.gr?")}
      </h2>
